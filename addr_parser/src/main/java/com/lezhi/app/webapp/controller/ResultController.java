    ...
    public String result(HttpServletRequest request, HttpServletResponse response,
        ...
        if (StringUtils.isNotBlank(__keywords)) {
            ...
            if (residences != null && !residences.isEmpty()) {
                ...
                count = resolvedAddrMapper.countByResidences("address_unique", rids, building, room);
                if (count > 0) {
                    ...
                    List<ResolvedAddress> list = resolvedAddrMapper.findByResidences("address_unique", rids, building, room, rowBounds);
